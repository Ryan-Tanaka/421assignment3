...
public class SQLStatParser extends Parser {
	...
	public SQLStatParser(TokenStream input) {
		super(input);
	...
	public static class StatContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitStat(this);
	...
	public static class SelectFromWhereContext extends QueryContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitSelectFromWhere(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SelectFromContext extends QueryContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitSelectFrom(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SelectAllContext extends Select_clauseContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitSelectAll(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SelectColsContext extends Select_clauseContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitSelectCols(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FromTnamesContext extends From_clauseContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitFromTnames(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class WhereConditionsContext extends Where_clauseContext {
		public TerminalNode WHERE() { return getToken(SQLStatParser.WHERE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitWhereConditions(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CondContext extends ConditionsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitCond(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LessExpContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitLessExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class EqExpContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitEqExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class GrtrEqExpContext extends ExprContext {
		...
		public TerminalNode GREATEQ() { return getToken(SQLStatParser.GREATEQ, 0); }
		public GrtrEqExpContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitGrtrEqExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class GrtrExpContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitGrtrExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LessEqExpContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLStatVisitor ) return ((SQLStatVisitor<? extends T>)visitor).visitLessEqExp(this);
			else return visitor.visitChildren(this);
		}
	}
